...
import { UserProfileModal } from "../UserProfileModal"; // Adjust path if necessary
...
export const Sidebar: React.FC<SidebarProps> = ({ navItems, userInitials }) => {
  ...
  return (
    <>
      ...
      {/* Render Profile Modal Layer safely outside the aside element */}
      <AnimatePresence>
        {isProfileOpen && (
          <UserProfileModal 
