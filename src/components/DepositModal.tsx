...
interface DepositModalProps {
  isOpen: boolean;
  onClose: () => void;
  onInitializeDeposit: (amount: number, escrowId?: number | string) => Promise<string | null>;
  escrowId?: number | string;
}

export const DepositModal: React.FC<DepositModalProps> = ({ isOpen, onClose, onInitializeDeposit, escrowId }) => {
