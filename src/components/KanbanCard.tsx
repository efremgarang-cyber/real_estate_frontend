  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-4">
        ...
        <button title="prop"className="text-gray-300 hover:text-[#141414] transition-colors p-1" onClick={(e) => e.stopPropagation()}>
      ...
      <div className="grid grid-cols-3 gap-2 mt-4 pt-4 border-t border-gray-100 opacity-0 group-hover:opacity-100 transition-opacity">
        <button title="email" onClick={(e) => { e.stopPropagation(); window.location.href = `mailto:${task.email}`; }} className="flex items-center justify-center py-2 bg-gray-50 hover:bg-gray-100 rounded-lg text-gray-500 transition-colors"><Mail size={14} /></button>
        <button title="phone" onClick={(e) => { e.stopPropagation(); if(task.phone) window.location.href = `tel:${task.phone}`; }} className="flex items-center justify-center py-2 bg-gray-50 hover:bg-gray-100 rounded-lg text-gray-500 transition-colors"><Phone size={14} /></button>
        <button title="calendar" onClick={(e) => e.stopPropagation()} className="flex items-center justify-center py-2 bg-gray-50 hover:bg-gray-100 rounded-lg text-gray-500 transition-colors"><Calendar size={14} /></button>
      </div>
    </div>
  );
};