        ...
        <div className="max-w-md w-full p-10 bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)]">
          ...
          <div className="flex flex-col items-center justify-center mb-6">
            <div className="w-16 h-16 bg-[#141414] rounded-full flex items-center justify-center shadow-md">
              <img src="/makao-icon-light.svg" alt="Makao Logo" className="w-8 h-8 object-contain" />
            </div>
          </div>
              ...
              <>
                ...
                <div className="flex gap-3 mb-2">
                  <button
                    ...
                    className={`flex-1 py-2.5 text-[11px] font-bold uppercase tracking-wider rounded-xl transition-colors border-2 ${
                      accountType === 'client' 
                ...
                {accountType === 'agent' && (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:outline-none focus:border-[#141414] transition-colors font-mono tracking-widest uppercase text-sm text-[#141414] placeholder-gray-400"
