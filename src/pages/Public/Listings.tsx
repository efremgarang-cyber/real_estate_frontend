...
export const PublicListings = () => {
  ...
  const filteredProperties = properties.filter((item) => {
    ...
    // FIX: Fallback to empty strings ("") before calling prototype string methods
    // This prevents runtime crashes when the database returns null for location or city
    const matchesSearch = 
  ...
  // Helper function to safely resolve the Supabase signed URL
  const resolvePropertyImage = (property: any): string => {
    ...
    // Prioritize the signed URL generated by the Laravel model accessor
    return firstImage.signed_url || firstImage.s3_path || fallbackImage;
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0A0A0A] font-sans pb-24 text-[#141414] dark:text-white">
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-6">
        ...
        <p className="text-sm font-medium text-gray-500 dark:text-gray-400 mt-3 max-w-xl">
          Browse verified premium properties listed across all certified real estate agencies subscribing to the Makao secure platform infrastructure.
        </p>
      </div>
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="grid grid-cols-3 gap-2 py-4 border-t border-gray-100 dark:border-gray-900 shrink-0">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      {/* FIXED: Bound explicitly to server 'baths' attribute value */}
