...
export const PublicListings = () => {
  ...
  // Fetch unified properties index from your shared public endpoint
  useEffect(() => {
  ...
  // Compute live filter matches across multi-agency datasets
  const filteredProperties = properties.filter((item) => {
    const searchLower = searchQuery.toLowerCase();

    // Fallback to empty strings ("") before calling prototype string methods
    const matchesSearch = 
      ...
      <main className="mx-auto px-4 sm:px-6 lg:px-8 mt-4">
        <div className="space-y-4 mb-8">
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            {/* Interface Filter Action Triggers */}
            <div className="flex gap-3">
              <button
                type="button"
                onClick={() => setShowFilters(!showFilters)}
                className={cn(
                  "cursor-pointer flex items-center gap-2 px-5 py-3 border rounded-xl font-bold text-sm transition-colors",
                  showFilters 
                    ? "bg-[#141414] dark:bg-white text-white dark:text-[#141414] border-transparent" 
                    : "bg-white dark:bg-[#141414] border-gray-300 dark:border-gray-800 text-gray-600 dark:text-gray-300 hover:bg-gray-50"
                )}
              >
          ...
          {/* Expandable Advanced Refinement Drawer */}
          {showFilters && (
            <div className="p-6 bg-white dark:bg-[#141414] border border-gray-300 dark:border-gray-800 rounded-2xl grid grid-cols-1 sm:grid-cols-2 gap-4 animate-in fade-in slide-in-from-top-2 duration-200">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-2.5 bg-gray-50 dark:bg-[#0A0A0A] border border-gray-300 dark:border-gray-800 rounded-xl focus:outline-none text-sm text-[#141414] dark:text-white"
                />
              </div>
              <div>
                ...
                <select 
                  ...
                  className="cursor-pointer w-full px-4 py-2.5 bg-gray-50 dark:bg-[#0A0A0A] border border-gray-300 dark:border-gray-800 rounded-xl focus:outline-none text-sm text-gray-700 dark:text-gray-200 font-medium"
                >
        ...
        {/* Dynamic State Loading Spinner UI */}
        {isLoading ? (
              ...
              >
                ...
                <div className="h-56 bg-gray-100 dark:bg-black relative overflow-hidden shrink-0">
                  ...
                  <div className="absolute top-4 left-4 flex gap-1.5">
                    <span className="px-2.5 py-0.5 bg-[#141414]/90 backdrop-blur-md text-white text-[9px] font-bold uppercase tracking-widest rounded-md">
                      {property.status}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-6 flex flex-col flex-1">
                  <div className="flex-1">
                    ...
                    <h3 className="text-sm font-bold text-gray-800 dark:text-gray-100 line-clamp-1 leading-snug">
                      {property.title}
                    </h3>
                  ...
                  {/* Quantitative Architectural Metadata Grid matching server columns */}
                  <div className="grid grid-cols-3 gap-2 py-4 border-t border-gray-100 dark:border-gray-900 shrink-0">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      {/* Bound explicitly to server 'baths' attribute value */}
                  ...
                  {/* Agency Source Affiliation Badge */}
                  <div className="pt-3 border-t border-gray-50 dark:border-gray-900 flex items-center justify-between mt-auto text-gray-400 dark:text-gray-500 shrink-0">
                    <div className="flex items-center gap-1.5 min-w-0">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-wider truncate">
                        {property.agency?.name || "Independent Network"}
                      </span>
                    </div>
...
// ── BACKEND ALIGNED MULTI-AGENCY MOCK DATA ──
